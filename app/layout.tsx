...
export const metadata: Metadata = {
  ...
  description:
    "Rentenauskunft online beantragen: Renteninformation, Versicherungsverlauf & Rentenbescheid schnell anfordern. Deutsche Rentenversicherung Service.",
  keywords: [
    "Rentenauskunft",
  ...
  return (
    <html lang="de" className={`${barlow.variable} ${notoSans.variable}`}>
      <head>
        ...
        <meta name="theme-color" content="#083163" />
      </head>
      <Script
        async
        src="https://www.googletagmanager.com/gtag/js?id=AW-17773793147"
